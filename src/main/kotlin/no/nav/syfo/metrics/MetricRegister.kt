...
val FERDIGSTILT_OPPGAVE_COUNTER: Counter = Counter.build()
    .namespace(METRICS_NS)
...
val MERKNAD_COUNTER: Counter = Counter.Builder()
    .namespace(METRICS_NS)
    .name("merknad_counter")
    .labelNames("merknad")
    .help("Counts the amount of times a merknad is registered").register()
