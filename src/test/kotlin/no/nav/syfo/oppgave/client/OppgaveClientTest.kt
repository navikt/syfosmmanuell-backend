...
object OppgaveClientTest : Spek({
    ...
    describe("Test av ferdigstillOppgave") {
        it("Ferdigstiller oppgave") {
            var opprettOppgaveResponse: OpprettOppgaveResponse? = null
            runBlocking {
                opprettOppgaveResponse = oppgaveClient.ferdigstillOppgave(FerdigstillOppgave(id = 2, versjon = 2, status = OppgaveStatus.FERDIGSTILT, tildeltEnhetsnr = "1234", tilordnetRessurs = "4321"), "123")
            }
        ...
        it("Kaster feil hvis ferdigstilling feiler") {
            assertFailsWith<RuntimeException> {
                runBlocking {
                    oppgaveClient.ferdigstillOppgave(FerdigstillOppgave(id = 3, versjon = 2, status = OppgaveStatus.FERDIGSTILT, tildeltEnhetsnr = "1234", tilordnetRessurs = "4321"), "123")
                }
            }
        }
    }
